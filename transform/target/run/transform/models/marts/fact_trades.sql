...
create or replace transient table REALTIME_DV_DB.STAGING_MARTS.fact_trades
    ...
    SELECT 
        ...
        hk_trade_id,
        hk_account_id
    FROM REALTIME_DV_DB.STAGING_VAULT.link_trade_account
),
...
sat_trade AS (
    SELECT 
        ...
        trade_timestamp,
        load_timestamp
    FROM REALTIME_DV_DB.STAGING_VAULT.sat_trade_details
)
...
FROM REALTIME_DV_DB.STAGING_VAULT.hub_trade t
